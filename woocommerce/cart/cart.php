			...
			<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
				<thead>
					<tr>
						...
						<th class="product-thumbnail"><span class="screen-reader-text-show"><?php esc_html_e(' mage', 'woocommerce'); ?></span></th>
						...
						<th class="product-remove"><span class="screen-reader-tex-show"><?php esc_html_e('Remove item', 'woocommerce'); ?></span></th>
